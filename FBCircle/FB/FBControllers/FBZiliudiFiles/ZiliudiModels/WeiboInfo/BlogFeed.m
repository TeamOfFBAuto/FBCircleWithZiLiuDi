...
-(id)initWithJson:( NSDictionary *)conentJson
{
    if ([self init]) {
        ...
        _title=[conentJson objectForKey:BLOG_TITLE];
        _content= [conentJson objectForKey:BLOG_CONTENT]==nil||[@"" isEqualToString:[conentJson objectForKey:BLOG_CONTENT]]?@"...":[conentJson objectForKey:BLOG_CONTENT];
        _dateline=  [ZSNApi timestamp:[conentJson objectForKey:BLOG_DATELINE]];
