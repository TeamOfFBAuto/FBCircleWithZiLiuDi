//
//  GMRefreshTableView.h
//  FBCircle
//
//  Created by gaomeng on 14/11/1.
...
@interface GMRefreshTableView : UITableView<L_EGORefreshTableDelegate,UITableViewDataSource,UITableViewDelegate>
