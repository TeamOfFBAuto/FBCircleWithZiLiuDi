...
- (void)viewDidLoad
{
    ...
    [nav setBackgroundImage:FBCIRCLE_NAVIGATION_IMAGE forBarMetrics: UIBarMetricsDefault];
    ...
    weibo_view.image = [ZSNApi getImageWithName:@"write_blog_back@2x"];
    ...
    [huatiButton setImage:[ZSNApi getImageWithName:@"talk_write@2x"] forState:UIControlStateNormal];
    ...
    [at_button setImage:[ZSNApi getImageWithName:@"write_blog_at@2x"] forState:UIControlStateNormal];
    ...
    [face_button setImage:[ZSNApi getImageWithName:@"smile_write@2x"] forState:UIControlStateNormal];
...
-(void)fasong:(UIButton *)sender
{
    ...
    {
        [ZSNApi showAutoHiddenMBProgressWithText:@"内容不能超过140个字" addToView:self.view];
        return;
    }
    ...
    MBProgressHUD * hud = [ZSNApi showMBProgressWithText:@"正在发送..." addToView:self.view];
    ...
    [_requset setCompletionBlock:^{
        ...
        @try {
            ...
            {
                [ZSNApi showAutoHiddenMBProgressWithText:@"发送失败,请重试" addToView:self.view];
            }
        }
...
//        [alertView show];
        [ZSNApi showAutoHiddenMBProgressWithText:@"网络不稳定,请检查当前网络" addToView:self.view];
...
{
    isFace = !isFace;
    [button setImage:[ZSNApi getImageWithName:isFace?@"write_blog_key@2x":@"smile_write@2x"] forState:UIControlStateNormal];
