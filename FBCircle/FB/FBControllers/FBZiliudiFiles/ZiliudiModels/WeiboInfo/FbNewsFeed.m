...
-(id)initWithJson:( NSDictionary *)conentJson
{
    if ([self init])
    {
        _title=[conentJson objectForKey:FB_BBS_TITLE];
        
        _content=[conentJson objectForKey:FB_BBS_CONTENT]==nil||[@"" isEqualToString:[conentJson objectForKey:BLOG_CONTENT]]?@"...":[conentJson objectForKey:FB_BBS_CONTENT];
